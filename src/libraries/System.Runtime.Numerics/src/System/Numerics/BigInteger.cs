...
namespace System.Numerics
{
          ...
          ISignedNumber<BigInteger>
    {
        ...
        public int Sign { get { AssertValid(); return (_sign >> (kcbitUint - 1)) - (-_sign >> (kcbitUint - 1)); } }
        ...
        public static double Log(BigInteger value) => Log(value, Math.E);
